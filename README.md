...
We now have a good understanding of how search difficulty affects search performance and efficiency, but which search behaviors (gaze patterns and actions) are most affected by search difficulty? Addressing this question and others will be tackled in the next two installments. 
